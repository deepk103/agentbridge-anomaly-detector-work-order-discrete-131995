...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Anomaly Detector • Work Order (Discrete)"
    environment = "production"
    Name = "agentbridge-anomaly-detector---work-order--discrete-"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-anomaly-detector---work-order--discrete--"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-anomaly-detector---work-order--discrete-"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-anomaly-detector---work-order--discrete--data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-anomaly-detector---work-order--discrete--bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-anomaly-detector---work-order--discrete--ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-anomaly-detector---work-order--discrete--ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-anomaly-detector---work-order--discrete--flow"
